> 原文：[`dev.mysql.com/doc/refman/8.0/en/mysql-shell-tutorial-javascript-collections-add.html`](https://dev.mysql.com/doc/refman/8.0/en/mysql-shell-tutorial-javascript-collections-add.html)
